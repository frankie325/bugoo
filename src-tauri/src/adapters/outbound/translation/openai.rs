...
impl WordInsightProvider for OpenAiTranslationProvider {
...
mod tests {
    ...
    fn new_rejects_missing_api_key() {
        ...
        let result = OpenAiTranslationProvider::new(config);
    ...
    fn prompt_builders_append_custom_prompt() {
        ...
        let provider = OpenAiTranslationProvider::new(config).unwrap();
    ...
    #[test]
    fn http_error_message_uses_openai_error_fields() {
